# Clone Commercial License

Copyright (c) 2024-2026 Clone Labs, Inc. (dba Clone). All rights reserved.

## 1. Definitions

"Licensed Work" means the Melone software covered by this license,
including its source code and documentation, and any binaries built from
that source code.

"Licensor" means Clone Labs, Inc. (dba Clone).
...
prebuilt builds of Melone distributed by the Licensor. Use of official
builds is governed by the Melone Terms of Service at
https://clone.is/melone and by the terms of your subscription or other
app license.
...
(5) or more users at one company require a Melone Team or Enterprise
...
headcount, revenue, or funding. Contact minchan@clone.is.
